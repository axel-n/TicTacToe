...
public class GameControllerTest {
    ...
    public void testGetWinnerForDiags() throws Exception {
        ...
        Assert.assertEquals(players[1],gameControllerLeft.getWinner());
        ...
        Assert.assertEquals(players[0],gameControllerRight.getWinner());
    }
    ...
    public void testGetWinnerForCustomBoard() throws Exception {
        ...
        Assert.assertEquals(players[1],gameControllerWin.getWinner());
    ...
    public void testGetWinnerForLines() throws Exception {
        ...
        for (int i=0;i<3;i++) {
            ...
            Assert.assertEquals(players[1], gameController.getWinner());
        }
    }
    ...
    public void testGetPlayers() throws Exception {
        ...
        players[1] = new Player("Xo", Figure.O);
        final GameController gameController = new GameController(gameName, players, board);
        Assert.assertArrayEquals(players, gameController.getPlayers());
    }
    ...
    public void testGetCurrentPlayer() throws Exception {
        ...
        board.setFigure(2,0,testValueO);
        board.setFigure(1,0,testValueX);
        Assert.assertEquals(players[1],gameController.getCurrentPlayer(players[1]));
        Assert.assertEquals(players[0],gameController.getCurrentPlayer(players[0]));
    }
